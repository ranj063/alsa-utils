...
const struct build_function_map object_build_map[] = {
	...
	{"Base", "scale", "scale", &tplg_build_scale_object, &tplg_create_scale_template},
	{"Base", "ops", "ops" ,&tplg_build_ops_object, &tplg_create_ops_template},
	{"Base", "extops", "extops" ,&tplg_build_ops_object, &tplg_create_ops_template},
	{"Base", "channel", "channel", &tplg_build_channel_object,
	 &tplg_create_channel_template},
	...
	{"Base", "hw_config", "SectionHWConfig", &tplg_build_hw_cfg_object,
	 &tplg_create_hwcfg_template},
	{"Base", "fe_dai", "dai", &tplg_build_fe_dai_object, tplg_create_fe_dai_template},
